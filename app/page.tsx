...
const LiveChat = dynamic(() => import('@/components/live-chat').then(mod => ({ default: mod.LiveChat })), {
  ssr: false,
  loading: () => null, // Don't show loading spinner for chat button
});
  ...
  return (
    <div className="bg-slate-900 text-white font-sans scroll-smooth">
          ...
          {isMobileMenuOpen && (
            <div className="md:hidden py-4 border-t border-slate-700">
              <div className="flex flex-col space-y-4">
                ...
                <button onClick={() => scrollToSection('music')} className="text-gray-300 hover:text-orange-400 transition-colors text-left">Music</button>
      ...
      <section className="min-h-screen flex flex-col items-center justify-center text-center px-4 relative overflow-hidden pt-16">
        {/* DJ Hands Background Image - Optimized with Next Image */}
        <div className="absolute inset-0 bg-slate-900">
          <Image
            src="/images/dj-hands-background.jpg"
            alt="DJ hands background"
            fill
            priority
            quality={85}
      ...
      <section id="about" className="px-6 py-16 max-w-4xl mx-auto relative">
        {/* Subtle DJ Background - Lazy loaded */}
        <div className="absolute inset-0 bg-slate-800 opacity-10 overflow-hidden">
          <Image
            src="/images/dj-hands-background.jpg"
            alt=""
            fill
      ...
      {/* Music Section */}
      <section id="music" className="px-6 py-16 bg-gradient-to-r from-purple-900/20 to-pink-900/20">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold mb-8 text-purple-400 text-center font-mono tracking-wider">LISTEN TO MY MIXES</h2>
          <Card className="bg-slate-800 border-purple-600 hover:border-purple-500 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20">
            <CardContent className="p-8">
              <div className="text-center mb-6">
                <div className="text-6xl mb-4">🎵</div>
                <h3 className="text-2xl font-semibold text-white mb-4">Check Out My Mixcloud</h3>
                <p className="text-gray-300 mb-6 leading-relaxed max-w-2xl mx-auto">
                  Listen to my latest mixes featuring Bollywood, Tollywood, Hip-Hop, and EDM. 
                  Get a taste of what DJ Vish brings to every event!
                </p>
                <a 
                  href="https://www.mixcloud.com/Djvishmusic1/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="inline-block"
                >
                  <Button 
                    className="bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white px-8 py-4 rounded-full text-lg font-semibold shadow-2xl hover:shadow-purple-500/25 transition-all duration-300"
                  >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8 text-sm text-gray-400">
                <div className="flex flex-col items-center">
                  <div className="w-2 h-2 bg-purple-400 rounded-full mb-2"></div>
                  <span className="text-center">Latest Mixes</span>
                </div>
                <div className="flex flex-col items-center">
                  <div className="w-2 h-2 bg-purple-400 rounded-full mb-2"></div>
                  <span className="text-center">Bollywood Hits</span>
                </div>
                <div className="flex flex-col items-center">
                  <div className="w-2 h-2 bg-purple-400 rounded-full mb-2"></div>
                  <span className="text-center">Hip-Hop & EDM</span>
                </div>
                <div className="flex flex-col items-center">
                  <div className="w-2 h-2 bg-purple-400 rounded-full mb-2"></div>
                  <span className="text-center">Live Sets</span>
                </div>
              </div>
            </CardContent>
          </Card>
      ...
      <section id="gallery" className="px-6 py-16 bg-gradient-to-r from-blue-900/10 to-cyan-900/10">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold mb-8 text-blue-400 text-center font-mono tracking-wider">MEDIA GALLERY</h2>
          <MediaGallery />
        </div>
      </section>
        ...
        <div className="mt-8 text-center">
          <div className="grid md:grid-cols-3 gap-6">
            <div className="flex items-center justify-center space-x-2 text-gray-300">
              ...
              <span>(774) 810-8481</span>
            </div>
            <div className="flex items-center justify-center space-x-2 text-gray-300">
              <Mail className="w-5 h-5 text-orange-400" />
              <span>teja93560@gmail.com</span>
            </div>
            <div className="flex items-center justify-center space-x-2 text-gray-300">
      ...
      <footer className="bg-slate-800 border-t border-slate-700 py-8">
        ...
        <div className="flex justify-center space-x-6 mb-4">
            ...
            <a href="https://www.facebook.com/DjVishMusic/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-orange-400 transition-colors">
              Facebook
            </a>
            <a href="https://www.mixcloud.com/Djvishmusic1/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-purple-400 transition-colors">
              Mixcloud
            </a>
